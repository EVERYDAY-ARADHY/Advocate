        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/80">
              ...
              <li><a href="#practice-areas" className="hover:text-background transition-colors">Practice Areas</a></li>
              <li><a href="#courts" className="hover:text-background transition-colors">Courts</a></li>
            </ul>
          </div>
        </div>
